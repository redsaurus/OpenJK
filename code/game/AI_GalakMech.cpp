...
void NPC_GM_Pain( gentity_t *self, gentity_t *inflictor, gentity_t *attacker, const vec3_t point, int damage, int mod,int hitLoc )
{
...
//	if ( frameNavInfo.flags & NIF_COLLISION )
//	{

...
stringID_table_t vmAnimTable [MAX_VIEWMODEL_ANIMATIONS+1] = {
	...
	ENUM2STRING(VM_IDLE),
	ENUM2STRING(VM_RAISE),
	ENUM2STRING(VM_LOWER),
	ENUM2STRING(VM_FIRE),
	ENUM2STRING(VM_MELEE),
	ENUM2STRING(VM_RELOAD),
	...
	ENUM2STRING(VM_FGRIP_RELEASE),
	ENUM2STRING(VM_FGRIP_THROW),
	ENUM2STRING(VM_FHEAL_QUICK),
	ENUM2STRING(VM_FHEAL_START),
	ENUM2STRING(VM_FHEAL_STOP),
	ENUM2STRING(VM_FLIGHTNING),
	ENUM2STRING(VM_FLIGHTNING_START),
	ENUM2STRING(VM_FLIGHTNING_HOLD),
	ENUM2STRING(VM_FLIGHTNING_RELEASE),
	ENUM2STRING(VM_FRESISTPUSH),
	ENUM2STRING(VM_FMINDTRICK1),
	ENUM2STRING(VM_FMINDTRICK2),
	
	// JA stuff
	ENUM2STRING(VM_2H_FLIGHTNING),
	ENUM2STRING(VM_2H_FLIGHTNING_HOLD),
	ENUM2STRING(VM_2H_FLIGHTNING_RELEASE),
	ENUM2STRING(VM_FDRAIN),
	ENUM2STRING(VM_FDRAIN_START),
	ENUM2STRING(VM_FDRAIN_HOLD),
	ENUM2STRING(VM_FDRAIN_RELEASE),
	ENUM2STRING(VM_FPROTECT),
	ENUM2STRING(VM_FPROTECT_FAST),
	ENUM2STRING(VM_FRAGE),
	ENUM2STRING(VM_FABSORB),
	ENUM2STRING(VM_FABSORB_START),
	ENUM2STRING(VM_FABSORB_END),
